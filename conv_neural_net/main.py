...
trainL1 = aeL1.fit(corruption_quantity=0.0, learning_rate=0.00005, batch_size=batch_size, have_sparsity_penalty=True, type_cost='SQUAREMEAN', learning_type='RMSPROP')
