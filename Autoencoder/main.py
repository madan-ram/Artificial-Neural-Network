...
aeL1 = AutoEncoder.AutoEncoder(number_of_input_layer=window_size*window_size*3, number_of_hidden_layer=100)
...
trainL1 = aeL1.fit(corruption_quantity=0.20, learning_rate=0.01, batch_size=batch_size, have_sparsity_penalty=False, cost_type='SQUAREMEAN', learning_type='SGD')
